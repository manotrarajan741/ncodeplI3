...
@Component({
  selector: 'page-mostindscore',
  templateUrl: 'mostindscore.html',
})
export class MostindscorePage {
...
mostindscore:any;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad MostindscorePage');
			...
			data => {
				 ...
				 if(this.resultData.flag == true)
				 {
					 if(this.resultData.data.length > 0){
						 this.mostindscore = this.resultData.data;
						 this.notfound=0;
					   }  	 
					 else{
						this.notfound=1;
